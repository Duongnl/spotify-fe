  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black text-white">
      ...
      <div className="w-full max-w-md space-y-3 px-6">
        <Button
          className="flex h-12 w-full items-center justify-center gap-2 rounded-full border-neutral-700 bg-transparent text-white hover:bg-neutral-800"
        >
          ...
          <span className="ml-2">Tiếp tục bằng Google</span>
        </Button>
        ...
        >
          ...
          <span className="ml-2">Tiếp tục bằng Facebook</span>
        </Button>
        ...
        >
          ...
          <span className="ml-2">Tiếp tục bằng Apple</span>
        </Button>
      ...
      {/* Divider */}
      <div className="my-6 w-full max-w-md px-6">
      ...
      <div className="w-full max-w-md px-6">
        <div className="mb-6">
          <label htmlFor="emailOrUsername" className="mb-2 block font-medium">
          ...
          <input
            ...
            className="h-12 bg-[#121212] text-white border-neutral-700 w-full max-w-md"
        ...
        <Button className="h-12 w-full rounded-full bg-[#1DB954] text-black hover:bg-[#1ed760] font-bold">
          Tiếp tục
        </Button>
